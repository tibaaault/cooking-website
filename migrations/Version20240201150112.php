 ...
 */
final class Version20240201150112 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE step CHANGE id_recette_id recette_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE step CHANGE recette_id id_recette_id INT NOT NULL');
