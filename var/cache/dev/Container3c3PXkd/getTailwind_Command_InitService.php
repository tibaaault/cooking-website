...
class getTailwind_Command_InitService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['tailwind.command.init'] = $instance = new \Symfonycasts\TailwindBundle\Command\TailwindInitCommand(($container->privates['tailwind.builder'] ?? $container->load('getTailwind_BuilderService')), \dirname(__DIR__, 4));
