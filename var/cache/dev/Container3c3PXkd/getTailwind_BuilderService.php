...
class getTailwind_BuilderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['tailwind.builder'] = new \Symfonycasts\TailwindBundle\TailwindBuilder(\dirname(__DIR__, 4), (\dirname(__DIR__, 4).'/assets/styles/app.css'), (\dirname(__DIR__, 3).'/tailwind'), NULL);
    }
}
