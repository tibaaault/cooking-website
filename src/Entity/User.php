...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'id_user', targetEntity: Favorites::class)]
    ...
    {
        if (!$this->id_user->contains($favorite)) {
            $this->id_user->add($favorite);
    ...
    {
        if ($this->id_user->removeElement($favorite)) {
            // set the owning side to null (unless already changed)
